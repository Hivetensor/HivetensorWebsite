      ...
      <nav className="border-b border-white/20 bg-black/95 backdrop-blur-sm fixed w-full z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/challenges" className="text-yellow-500">Challenges</Link>
      ...
      <section className="pt-24 pb-12 px-4 sm:px-6 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black mb-4 text-yellow-500">
              Active Challenges
            </h1>
          ...
          <div className="flex flex-col gap-4 mb-8">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/20 rounded-lg pl-10 pr-4 py-3 text-white placeholder-white/50 focus:border-yellow-500/50 focus:outline-none transition-colors"
              />
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              <select className="bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white focus:border-yellow-500/50 focus:outline-none transition-colors flex-1">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div className="bg-white/5 border border-yellow-500/50 p-6 relative animate-glow">
              ...
              <h3 className="text-xl font-bold mb-2 text-yellow-500">E-commerce Conversion Prediction</h3>
            ...
            <div className="bg-white/5 border border-white/20 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="px-2 py-1 bg-yellow-500/20 text-yellow-500 text-xs rounded">ADVANCED</span>
              </div>
